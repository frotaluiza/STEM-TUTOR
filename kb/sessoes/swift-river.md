...
Sessão com **10 messages**, **41 parts**, agente **general**, modelo **deepseek-v4-flash** | 💰 $0.0135 | 💾 cache read: 336.6K | ⏱️ 0h02m14s

## 👤 Usuário (2026-06-17 23:00:59 UTC)
...
Return as a structured comparison table. Include Requena (2023), Lisboa (2024), Andrés-Mañas (2022) that I already know about, plus any others.

## 🤖 Assistente (2026-06-17 23:00:59 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-17 23:01:04 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-17 23:01:10 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-17 23:01:19 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-17 23:01:28 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-17 23:01:37 UTC) — Raciocínio
...
3. **Andrés-Mañas et al. (2022)** - "Characterization of the use of vacuum enhancement in commercial pilot-scale air gap membrane distillation modules with different designs" - V-AGMD (but no ML)
...
7. **Tashvigh & Nasernejad (2017)** - "Soft computing method for modeling and optimization of air and water gap membrane distillation—A genetic programming approach" - AGMD/WGMD, GP
...
14. **Andrés-Mañas et al. (2023)** - "Membrane distillation of high salinity feeds: Steady-state modelling and optimization of a pilot-scale module in vacuum-assisted air gap operation" - V-AGMD, RSM/modeling
...
## 🤖 Assistente (2026-06-17 23:02:12 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-17 23:02:36 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-17 23:02:45 UTC) — Raciocínio
...
4. **Tashvigh & Nasernejad (2017)** - "Soft computing method for modeling and optimization of air and water gap membrane distillation—A genetic programming approach" - GP - AGMD/WGMD - predict flux
...
13. **Andrés-Mañas et al. (2022)** - "Characterization of the use of vacuum enhancement in commercial pilot-scale air gap membrane distillation modules with different designs" - Desalination - Experimental characterization (not ML) - V-AGMD
14. **Andrés-Mañas et al. (2023)** - "Membrane distillation of high salinity feeds: Steady-state modelling and optimization of a pilot-scale module in vacuum-assisted air gap operation" - Desalination - RSM/modeling - V-AGMD
...
|---|-------|---------------|---------|------------|-----------|------------------------|----------------------|-------------------|---------|------------------|
| 1 | Artificial neural network modeling and optimization of desalination by air gap membrane distillation | **Khayet, Cojocaru** (2012) *Cited: 183* | Sep. Purif. Technol. | Feed-forward ANN (BP) | Not reported | No | No | R², MSE | **AGMD** | Permeate flux, salt rejection |
| 2 | Air gap membrane distillation: Desalination, modeling and optimization | **Khayet, Cojocaru** (2012) *Cited: 147* | Desalination | RSM (response surface) | Not reported | No | No | ANOVA, R² | **AGMD** | Permeate flux |
| 3 | Using neural networks coupled with PSO for mathematical modeling of AGMD systems for desalination | **Shirazian, Alibabaei** (2017) *Cited: 55* | Neural Comput. & Applic. | ANN + PSO (Volterra series) | Not reported | No | No | R², MSE | **AGMD** | Flux, GOR, cold outlet temp |
| 4 | Soft computing method for modeling and optimization of air and water gap membrane distillation — GP approach | **Tashvigh, Nasernejad** (2017) *Cited: 18* | Desalination & Water Treat. | Genetic Programming (GP) | Not reported | No | No | R², MSE, AARD | **AGMD & WGMD** | Permeate flux |
| 5 | Heuristic optimization techniques for air gap membrane distillation system | **Khalifa et al.** (2017) *Cited: 25* | Arab. J. Sci. Eng. | RSM, ANN, GA | Not reported | Yes: RSM vs ANN | No | R², comparison | **AGMD** | Permeate flux |
| 6 | Effect of membrane deformation on performance of V-AGMD | **Kim et al.** (2022) *Cited: 2* | Membr. Water Treat. | MLR, GNN, MLFNN | Not reported | Yes: MLR vs GNN vs MLFNN | No | R² | **V-AGMD** | Permeate flux |
| 7 | Separation of HCl/water using AGMD, Taguchi optimization and ANN | **Kalla et al.** (2022) *Cited: 4* | Chem. Prod. Process Model | ANN (BP) + Taguchi | Not reported | No (ANN only) | No | R² (0.998), ANOVA | **AGMD** | Permeate flux |
| 8 | Characterization of vacuum enhancement in commercial pilot-scale AGMD modules | **Andrés-Mañas et al.** (2022) *Cited: 42* | Desalination | Experimental (no ML model) | N/A | N/A | N/A | N/A | **V-AGMD** | N/A (characterization) |
| 9 | Neural networks for predicting AGMD performance | **Yang** (2023) *Cited: 7* | Desalination | MLR, BP ANN, RBF ANN | Yes: 30 train / 10 external test | Yes: MLR vs BP ANN vs RBF ANN | No | R², RMSE, MIV analysis | **AGMD** (hollow fiber) | Permeate flux, GOR |
| 10 | Application of ML to characterize permeate quality in pilot-scale V-AGMD | **Requena et al.** (2023) *Cited: 6* | Membranes | Feed-forward ANN | Yes: train/val/test split (70/15/15) | No | No | RMSE, R² | **V-AGMD** (pilot) | Salt rejection factor (SRF), membrane leak ratio (MLR) |
| 11 | ML and computational approaches for designing MD modules | **Almahfoodh et al.** (2023) *Cited: 14* | Sep. Purif. Technol. | DNN, RF, XGBoost | Yes (not specified type) | Yes: DNN vs RF vs XGBoost | No | R², MAE | **MD** (incl. AGMD) | Permeate flux |
| 12 | ML-guided decisive factors of high-performance MD system | **Ma et al.** (2023) *Cited: 21* | Sep. Purif. Technol. | AutoML (multiple models) + PSO optimization | Yes: cross-val within AutoML | Yes: AutoML ensemble of multiple families | No | R², feature importance | **MD** (general) | Flux, wetting, fouling |
| 13 | Membrane distillation of high salinity feeds: steady-state modelling of V-AGMD | **Andrés-Mañas et al.** (2023) *Cited: 31* | Desalination | Physical / semi-empirical model | Not reported | No | Hybrid (physical model) | R², agreement with exp | **V-AGMD** | Permeate flux, GOR |
...
| 15 | ANN-GA driven prediction & optimization for photothermal AGMD | **Jawed et al.** (2025) *Cited: 4* | J. Environ. Chem. Eng. | ANN + GA optimization | Yes: train/test split | No | No | R² (0.94→0.99 after dropout), RMSE | **AGMD** (photothermal) | Permeate flux |
| 16 | CFD-guided surrogate modeling and interaction analysis of AGMD | **Abdulrahim et al.** (2026) *Cited: 1* | Desalination | CFD + ANN surrogate (feedforward) | Yes: hold-out validation (500 CFD sims) | No | **Yes** (CFD → ANN surrogate) | R² > 0.99, RMSE, ANOVA | **AGMD** | Permeate flux, STEC |
| 17 | Data-driven modeling and optimization of NESMD | **Elrakhawi et al.** (2026) | Appl. Water Sci. | ANN (review of ~20 ANN MD models) | Varies | Yes (review) | No | R² | **MD** (incl. AGMD) | Permeate flux |
| B1 | NEURO FUZZY SYSTEM (ANFIS) MODELING OF DESALINATION BY AGMD | **Piri et al.** (undated) | — | ANFIS (neuro-fuzzy) | Not reported | No | No | R², MSE | **AGMD** | Permeate flux |
| B2 | Improving distillate prediction of MD using ANN (trigeneration) | **Acevedo et al.** (2018) *Cited: 26* | Water | ANN | Not reported | No | No | R² | **MD** (DCMD/AGMD) | Distillate production |
| B3 | Optimization of benzene removal by AGMD using RSM | **Pedram & Mortaheb** (2019) *Cited: 8* | Water Sci. Tech.: Water Supply | RSM | Not reported | No | No | ANOVA, R² | **AGMD** | Benzene rejection |
| B4 | Statistical modeling and optimization of helical AGMD | **Shahu & Thombre** (2023) *Cited: 1* | Int. J. Environ. Sci. Technol. | RSM | Not reported | No | No | ANOVA, R² | **AGMD** (helical) | Permeate flux |
...
- **Lisboa (2024)** is a physics-based reduced model — not data-driven ML, but a valuable hybrid/physical approach.
...
- Cross-validation is **rarely reported** — most papers use simple train/test splits.
...
- **Andrés-Mañas (2022)** is NOT a modeling paper — it is experimental characterization of V-AGMD that users should be aware of but does not contain ML.

*Novo passo iniciado*

---

*10 messages | 41 parts | 💰 $0.0135 | ⏱️ 0h02m14s*
