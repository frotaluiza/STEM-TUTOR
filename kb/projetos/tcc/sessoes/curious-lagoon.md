---
slug: curious-lagoon
title: "Criar sessão opencode com dados de sessão anterior"
date: 2026-06-03
agent: build
...
Sessão com **5 messages**, **19 parts**, agente **build**, modelo **deepseek-v4-flash** | 💰 $0.0047 | 💾 cache read: 59.6K | ⏱️ 0h00m42s

## 👤 Usuário (2026-06-03 16:10:47 UTC)

é possivel eu criar uma sessão aqui no opencode que tenha as informações de uma sessão anterior?

## 🤖 Assistente (2026-06-03 16:10:47 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-03 16:11:19 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-03 16:11:21 UTC) — Raciocínio
...
## 🤖 Assistente (2026-06-03 16:11:24 UTC) — Raciocínio
...
Sim, é possível. O opencode oferece várias formas:

- **Continuar a última sessão**: `opencode -c`
- **Continuar uma sessão específica**: `opencode -s <sessionID>`
- **Fork (criar nova sessão a partir de uma anterior)**: `opencode -c --fork` ou `opencode -s <ID> --fork` — isso copia o histórico da sessão anterior para uma nova, sem modificar a original.
...
*5 messages | 19 parts | 💰 $0.0047 | ⏱️ 0h00m42s*
