...
SessÃ£o com **5 messages**, **31 parts**, agente **explore**, modelo **deepseek-v4-flash** | ðŸ’° $0.0053 | ðŸ’¾ cache read: 59.3K | â±ï¸ 0h00m23s

## ðŸ‘¤ UsuÃ¡rio (2026-07-13 00:22:09 UTC)
...
## ðŸ¤– Assistente (2026-07-13 00:22:09 UTC) â€” RaciocÃ­nio
...
## ðŸ¤– Assistente (2026-07-13 00:22:13 UTC) â€” RaciocÃ­nio
...
## ðŸ¤– Assistente (2026-07-13 00:22:16 UTC) â€” RaciocÃ­nio
...
## ðŸ¤– Assistente (2026-07-13 00:22:20 UTC) â€” RaciocÃ­nio
...
### `PRIMARY_NAV` â€” lines 44â€“95 (7 items)

| Lines | `href` | `label` | Icon | Requires |
|-------|--------|---------|------|----------|
| 46â€“51 | `/home` | Home | House | `llm` |
| 53â€“58 | `/partners` | Partners | HeartHandshake | `llm` |
| 60â€“68 | `/agents` | My Agents | Bot | _(none / un-gated)_ |
| 70â€“75 | `/co-writer` | Co-Writer | PenLine | `llm` |
| 77â€“82 | `/book` | Book | Library | `llm` |
| 84â€“88 | `/space` | Learning Space | LayoutGrid | _(none)_ |
| 90â€“94 | `/noteblocks` | NoteBlocks | FileText | _(none)_ |

### `SECONDARY_NAV` â€” lines 97â€“117 (3 items)

| Lines | `href` | `label` | Icon | Requires |
|-------|--------|---------|------|----------|
| 98â€“106 | `/memory` | Memory | Brain | _(none / un-gated)_ |
| 107â€“115 | `/knowledge` | Knowledge Center | BookOpen | _(none / un-gated)_ |
| 116 | `/settings` | Settings | Settings | _(none)_ |

---

## 2. project_state.py â€” Router Functions

**File:** `C:\Users\frota\Documents\Projetos\AI TUTOR\deeptutor\api\routers\project_state.py` (231 lines total)

### `get_focus_panel` â€” lines 47â€“66
```python
...
### `get_project_state` â€” lines 69â€“78
```python
...
### `get_project_state_raw` â€” lines 81â€“89
```python
...
### `_build_mind_map` helper â€” lines 92â€“231
...
### Key Pydantic models:
- `FocusPanel` (lines 37â€“45): `project`, `branch`, `last_commit`, `last_session`, `next_steps`, `pending_tasks`, `drift_warning`
- `ProjectMindMap` (lines 28â€“35): `nodes`, `edges`, `project`, `branch`, `last_commit`, `last_updated`
- `GraphNode` (lines 14â€“19): `id`, `label`, `type`, `subtitle`, `color`
- `GraphEdge` (lines 22â€“25): `source`, `target`, `label`
...
| `page.tsx` | file | Root redirect â†’ `/home` |
...
*5 messages | 31 parts | ðŸ’° $0.0053 | â±ï¸ 0h00m23s*
