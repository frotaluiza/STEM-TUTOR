...
SessÃ£o com **6 messages**, **32 parts**, agente **general**, modelo **deepseek-v4-flash** | ðŸ’° $0.0162 | ðŸ’¾ cache read: 277.5K | â±ï¸ 0h00m51s

## ðŸ‘¤ UsuÃ¡rio (2026-06-17 02:31:28 UTC)
...
1. **Qwen2.5-VL** â€” Was it fine-tuned on technical documents? What can it understand? Search for benchmarks on diagram/chart understanding.

2. **InternVL2 / InternVL2.5** â€” Same questions. Any fine-tuning on technical/scientific figures?

3. **Granite Docling 258M / 7B** (IBM) â€” This was specifically trained for document conversion. What can it understand? Circuit diagrams?

4. **Florence-2** (Microsoft) â€” Was trained on rich captions. Does it understand diagrams/charts?

5. **SmolVLM** (HuggingFace) â€” Lightweight. Benchmarks on document understanding?

6. **Idefics3 / Idefics2** â€” Document understanding capabilities?

7. **Phi-3.5-vision / Phi-4-vision** (Microsoft) â€” Trained on scientific data? Chart understanding?

8. **molmo** (Allen AI) â€” Any document/figure capabilities?

9. **DocOwl** / **mPLUG-DocOwl** â€” Specifically for document understanding.

10. **Any VLM that appears on the ChartQA, DocVQA, or InfoVQA leaderboards** â€” These are benchmarks for technical/chart/document understanding.
...
## ðŸ¤– Assistente (2026-06-17 02:31:29 UTC) â€” RaciocÃ­nio
...
## ðŸ¤– Assistente (2026-06-17 02:31:34 UTC) â€” RaciocÃ­nio
...
## ðŸ¤– Assistente (2026-06-17 02:31:40 UTC) â€” RaciocÃ­nio
...
## ðŸ¤– Assistente (2026-06-17 02:31:44 UTC) â€” RaciocÃ­nio
...
| **License** | Apache 2.0 |
| **Run locally?** | Yes â€” 7B needs ~16GB VRAM (BF16), 3B needs ~8GB |
...
| **License** | MIT |
| **Run locally?** | Yes â€” 8B needs ~16GB VRAM |
...
## 3. Granite Vision 3.1 (IBM) â€” 2B-preview (3B total with encoder)

| Property | Value |
|---|---|
| **Sizes** | 3B total (2B LLM + vision encoder) |
| **License** | Apache 2.0 |
| **Run locally?** | Yes â€” very lightweight, ~6GB VRAM |
...
| **License** | MIT |
| **Run locally?** | Yes â€” extremely lightweight, <2GB VRAM |
| **HF page** | https://huggingface.co/microsoft/Florence-2-large |
| **Technical understanding** | Good for OCR and captioning. Supports `<OCR>` and `<OCR_WITH_REGION>` task prompts. Trained on FLD-5B dataset with rich captions. Not specifically optimized for charts/diagrams â€” more of a generalist. |
...
**Verdict:** Great tiny model for OCR and general captioning, but **not** the best choice for diagram/chart understanding â€” it lacks the specialized document training of the others. Use it as an OCR preprocessing step.
...
| **License** | Apache 2.0 |
| **Run locally?** | Yes â€” 2.2B needs ~5.2GB VRAM (very efficient) |
...
| **License** | Apache 2.0 |
| **Run locally?** | Yes â€” 7B needs ~16GB VRAM |
...
**DocOwl2:** Specialized for **OCR-free multi-page document understanding**. Uses "High-resolution DocCompressor" â€” each page encoded with just 324 tokens. Designed specifically for document QA across multiple pages. Benchmarks: Strong on DocVQA, InfoVQA (exact scores not on model card but reported in paper).
...
| **Phi-3.5-vision-4B** | 81.8 | â€” | â€” | Older but decent |
| **Idefics3-8B** | â€” | 87.7 | â€” | Solid document |
| **SmolVLM2-2.2B** | 68.8 | 80.0 | â€” | Efficient but weaker |

Additional models to investigate:
- **PaliGemma 2** (Google) â€” good on DocVQA
- **Pixtral** (Mistral) â€” 12B, decent on charts
- **LLaVA-OneVision** â€” strong generalist, decent on documents
- **MiniCPM-V 2.6** â€” strong OCR capabilities

---

## Circuit/Electronics Diagram Understanding â€” Papers
...
- Proposes **LLM4-IC8K** framework with a **two-stage training**: synthetic IC footprint diagrams â†’ real-world datasheet drawings
...
| **Circuit diagrams** | **No existing VLM is good at this** â€” ICGeo8K paper shows all current models fail at geometric perception of electronic diagrams. This needs custom fine-tuning. |
...
*6 messages | 32 parts | ðŸ’° $0.0162 | â±ï¸ 0h00m51s*
