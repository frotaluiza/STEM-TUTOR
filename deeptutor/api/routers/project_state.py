...
from deeptutor.services.config.runtime_settings import get_runtime_settings

router = APIRouter(tags=["project"])

PROJECT_DIR = Path(__file__).resolve().parents[4]  # AI TUTOR/
...
@router.get("/api/v1/project/state", response_model=ProjectMindMap)
...
@router.get("/api/v1/project/state/raw")
